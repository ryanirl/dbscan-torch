...
Based on the grid-hashing approach from [pargeo][pargeo-paper] (Wang et al.,
SIGMOD 2020), reimplemented as a native PyTorch extension with CUDA support.
...
lighter than [pargeo][pargeo-paper], while also supporting GPU acceleration for
...
| [pargeo][pargeo-paper] (`pip install dbscan`) | parallel CPU | numpy | CPU at N < ~1M |
...
[`pip install dbscan`][pargeo-repo].

[pargeo-paper]: https://dl.acm.org/doi/10.1145/3318464.3380582
[pargeo-repo]: https://github.com/wangyiqiu/dbscan-python
